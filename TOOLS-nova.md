...
```bash
# 编辑配置
~/.openclaw/workspace/.daily-report-config.json
```
...
**日报访问：** `https://dylanwuzc.github.io/nova-daily-report`
...
| 来源 | 地址 | 类型 |
|------|------|------|
| CoinDesk | https://feeds.feedburner.com/CoinDesk | 加密新闻 |
| OpenAI | https://openai.com/blog/rss.xml | AI 研究 |
| Import AI | https://importai.substack.com/feed | AI 周报 |
| Hacker News | https://news.ycombinator.com/rss | 技术社区 |
| Decrypt | https://decrypt.co/feed | Web3 新闻 |
